...
#'@param method least cost path algorithm provided by the gdistance package. Options are "leastcost", "SPDistance" and "commute". see function \link{\code{costdistances}}.  
#'@param number of next neighboring cells to be used, default is 8. see function \link{\code{costdistances}}.  
...
#oo <- opt.landgen(fric.raster, nlocations = 8, mindist = 0, fixed = NULL, method = "leastcost", NN = 8, iter = 10, mask=NULL)
